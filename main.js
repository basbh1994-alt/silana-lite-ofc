...
◦ *الوقت المتصل*: ${new Date().toLocaleString()}\n\n قناتي على الواتساب للمزيد من المعلومات \https://whatsapp.com/channel/0029Vb3A0wrCnA7kStwYug0d`;
...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = 'مرحبا بك في أقوى مجموعة لبوتات الواتساب الرجاء قراءة قوانين المجموعة حتى لا يتم طردك  ، ذاك الامير سوف يقوم بطردك اذا خالفت  \n\n welcome to the groupe please read the rules of the group\n\n\n @subject, @user\n'
